...
const rows = await db.query('SELECT tipo, documento, data, hora, codigovend, operador, vendedores.nome\r\
FROM cancelamentos\r\
left join vendedores on  vendedores.numero = codigovend \r\
where cancelamentos.data>='+novadataini+' and cancelamentos.data<='+novadatafin+'  '+where+'');
