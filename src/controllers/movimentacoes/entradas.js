...
const rows = await db.query('SELECT distinct  entradas.documento, entradas.data, entradas.hora, codigovend, totaldesc, totalitens, totalgeral, entradas.operador, cancelado, alteracoes,\r\
bloqueado, tipo, origem,vendedores.nome from entradas inner join\r\
ientrada on ientrada.documento = entradas.documento inner join vendedores on  vendedores.numero = codigovend \r\
where entradas.data>='+novadataini+' and entradas.data<='+novadatafin+'  '+where+'');
